...
$CC -O0 -march=rv64id -mcmodel=medany -std=c23 -c "$file" -o target/$base_name.o -nostdlib -nodefaultlibs
$CC -O0 -march=rv64id -mcmodel=medany -std=c23 -c progs/whisker.c -o target/whisker.o -nostdlib -nodefaultlibs
